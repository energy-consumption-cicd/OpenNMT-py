...
PROJECT_NAME="opennmt-py"
IMAGE_NAME="${IMAGE_NAME:-opennmt-py-medicao}"
MEDICAO_DIR="$HOME/experimentos/medicao/repositorios/opennmt-py"
RESULTS_DIR="${RESULTS_DIR:-$HOME/experimentos/medicao/resultados/opennmt-py/runs}"
LOGS_DIR="${LOGS_DIR:-$HOME/experimentos/medicao/resultados/opennmt-py/logs}"
...
TIME_FILE="/tmp/opennmt_time_$$.txt"
...
if ! docker image inspect "$IMAGE_NAME" &>/dev/null; then
  ...
  echo "    ~/experimentos/repositorios/training-intensive/OpenNMT-py/" >&2
  exit 1
fi
